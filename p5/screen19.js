const screen19 = ( sketch ) => {
    ...
    var x,y;
     let img;
    let user = shuffled_headlines[18][0];
let headline = shuffled_headlines[18][1];
let imgPath = shuffled_headlines[18][2];
let shapes = [];
